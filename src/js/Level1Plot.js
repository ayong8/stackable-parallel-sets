...
function Level1Plot() {
  ...
  function _level1Plot(selection) {
    ...
    selection
      ...
      .attr('x', (d, i) => xGoalScale.bandwidth()/3 + xGoalScale(d))
      .attr('y', lCom.hPlot.goalPlot.h/3*2)
      .attr('width', (d, i) =>
        i == dataForGoals.length - 1 ? xGoalScale.bandwidth()/3 : xGoalScale.bandwidth()/3 - lCom.hPlot.goalPlot.m
      )
      .attr('height', lCom.hPlot.goalPlot.featureRect.h)
      .style('fill', 'white')
    ...
    selection
      ...
      .text(d => d)
      .attr('x', (d, i) => xGoalScale.bandwidth()/3 + xGoalScale(d))
      .attr('y', lCom.hPlot.goalPlot.h/3*2 - 3)
      ...
      const gClsForGoal = selection
        ...
        .attr(
          ...
          'translate(' +
            ...
            ',' +
            (lCom.hPlot.goalPlot.featureRect.t + lCom.hPlot.goalPlot.featureRect.h + 5) +
            ')'
        );
